    ...
    haskell-nix = with final.haskell-nix; {
       ...
       # TODO: Marked for deletion
        ...
        withInputs = final.recurseIntoAttrs;
          ...
          # List the packages bundled with GHC.  Non-exact development shells
          # include all of them so tools can use packages that are available
          # from the compiler even when they are not reachable from the

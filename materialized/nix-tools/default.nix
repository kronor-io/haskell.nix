  ...
  pkgs = hackage:
    {
      packages = {
        ...
        template-haskell-lift.revision = hackage.template-haskell-lift."0.1.0.0".revisions.default;
        ...
        cabal-install.flags.lukko = false;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "template-haskell-lift".components.library.planned = lib.mkOverride 900 true;
